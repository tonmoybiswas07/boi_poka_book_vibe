...
const Book = ({ book }) => {
  const { image, bookName, publisher, category, rating } = book;
  console.log(book);
  return (
    <div className="card bg-base-100 w-96 shadow-sm p-6">
      ...
      <div className="mt-5">
        <div className="flex justify-start items-start gap-3.5 font-semibold text-[#23BE0A]">
          <h3 className="bg-green-50 px-2 py-2 rounded-full">Young Adult</h3>
          <h3 className="bg-green-50 px-2 py-2 rounded-full">Identity</h3>
        </div>
